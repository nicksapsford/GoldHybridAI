...
# Verdict thresholds (points, $/oz) -- classified on the 1hr post-decision window.
# System 5 Review desk-wide (18 Jul 2026): 10 -> 6. The old 10 sat above Gold's median
# hourly move (~7pt), classifying only ~27%% of windows; 6 (~median) restores ~50%%
# classification and a healthier Morgan learning signal. Existing rows re-scored on 18 Jul.
VERDICT_THRESHOLD = 6  # $6/oz on the 1hr window -- under = noise (NEUTRAL), over = CORRECT/WRONG
