"""
GoldHybrid AI -- paper_trader_gold.py  (Stanley)
...
log = logging.getLogger("GoldHybrid.Stanley")
...
class PaperTraderGold:
    ...
    def _log_trade(self, trade: GoldTrade, exit_meta: dict = None) -> None:
    ...
    def _save_summary(self) -> None:
        ...
        lines = [
            "=" * 50,
            "GoldHybrid AI -- Stanley Paper Trader Summary",
    ...
    def close_trade(self, price: float, reason: str, gbpusd: float = None,
                    exit_meta: dict = None) -> Optional[GoldTrade]:
        ...
        try:
            ...
            with open(path, "a", newline="", encoding="utf-8") as f:
                ...
                w.writerow({"timestamp_utc": datetime.now(timezone.utc).isoformat(),
                    "system": "GoldHybrid", "direction": t.direction, "entry_price": t.entry_price,
    ...
    def print_status(self) -> None:
        log.info("=" * 60)
        log.info("GoldHybrid AI -- Stanley Paper Trader Status")
        log.info("-" * 60)
